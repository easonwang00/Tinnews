...
public class HomeFragment extends Fragment implements CardStackListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // handle like and unlike button clicks
        ...
        viewModel
                .getTopHeadlines()
                .observe(
                        // get current view lifecycle, ensure observer only being notified when this lifecycle event is happening
                        getViewLifecycleOwner(),
                        // "observer object", a lambda expression, defining what to do when LiveData changes
                        newsResponse -> {
